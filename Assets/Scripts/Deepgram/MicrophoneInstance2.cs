...
public class MicrophoneInstance2 : MonoBehaviour
{
    AudioSource _audioSource;
    int lastPosition, currentPosition;

    //public DeepgramInstance _deepgramInstance;
    public DeepgramInstance2 _deepgramInstance2;
    ...
    void Update()
    {
        if ((currentPosition = Microphone.GetPosition(null)) > 0)
        {
            ...
            if (currentPosition - lastPosition > 0)
            {
                ...
                // if (_deepgramInstance != null) {
                //     _deepgramInstance.ProcessAudio(samplesAsBytes);
                // } else 
                if (_deepgramInstance2 != null) {
                    _deepgramInstance2.ProcessAudio(samplesAsBytes);
                }
